// app/(dashboard)/lab/pathology/emergency-orders/[orderId]/page.tsx
"use client";
...
import { PATHOLOGY_EMERGENCY_ORDERS } from "@/lib/lab/pathology/pathology-emergency-orders-data";
...
export default function PathologyEmergencyOrderDetailPage() {
  const params = useParams<{ orderId: string }>();
  const sourceOrder = PATHOLOGY_EMERGENCY_ORDERS.find((o) => o.id === params.orderId);
  const [order, setOrder] = useState<PathologyIpdOrder>(() => sourceOrder ?? PATHOLOGY_EMERGENCY_ORDERS[0]);
  ...
  const patientList: PatientListItem[] = PATHOLOGY_EMERGENCY_ORDERS.map((o) => ({
    uhid: o.patient.uhid,
    name: o.patient.name,
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px]">
        <PatientDetailShell
          ...
          patientsPath="/lab/pathology/emergency-orders"
          tabs={tabs}
          defaultTab="overview"
          hideSingleTab
        />
