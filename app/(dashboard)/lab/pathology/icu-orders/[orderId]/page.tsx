// app/(dashboard)/lab/pathology/icu-orders/[orderId]/page.tsx
"use client";
...
import { PATHOLOGY_ICU_ORDERS } from "@/lib/lab/pathology/pathology-icu-orders-data";
...
export default function PathologyIcuOrderDetailPage() {
  const params = useParams<{ orderId: string }>();
  const sourceOrder = PATHOLOGY_ICU_ORDERS.find((o) => o.id === params.orderId);
  const [order, setOrder] = useState<PathologyIpdOrder>(() => sourceOrder ?? PATHOLOGY_ICU_ORDERS[0]);
  ...
  const patientList: PatientListItem[] = PATHOLOGY_ICU_ORDERS.map((o) => ({
    uhid: o.patient.uhid,
    name: o.patient.name,
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px]">
        <PatientDetailShell
          ...
          patientsPath="/lab/pathology/icu-orders"
          tabs={tabs}
          defaultTab="overview"
          hideSingleTab
        />
