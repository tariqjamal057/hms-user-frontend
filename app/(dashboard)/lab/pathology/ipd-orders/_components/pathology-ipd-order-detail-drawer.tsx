...
import { TestStatusBadge, ResultFlagBadge } from "../../opd-orders/_components/pathology-status-badges";
...
export function PathologyIpdOrderDetailDrawer({
  order,
  onClose,
  onUpdateTest,
  onCollectPayment,
  ...
  const totalValue = getTotalIpdTestValue(selectedOrder);
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <InfoTileCard
          ...
          tone="emerald"
          value={selectedOrder.patient.ward}
          subtitle={`${selectedOrder.patient.room} · ${selectedOrder.patient.bed}`}
        />
      </div>
      ...
      {!allReportsReady && (
        <InfoAlertCard
          ...
          title="Tests pending"
          body="Complete all test reports before proceeding with billing."
        />
      )}
    </div>
  );
    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 border-t border-slate-100 pt-3 md:grid-cols-3">
        <InfoTileCard
          ...
          tone="slate"
          value={test.referenceRange.normalText}
        />
        <InfoTileCard
          title="Unit"
          tone="slate"
          value={test.referenceRange.unit}
        />
        <InfoTileCard
...
function PaymentDrawer({
  ...
  const options: Array<{
    ...
    { value: "Cash", label: "Cash", description: "Collect cash at counter", icon: Banknote, tone: "emerald" },
    { value: "UPI", label: "UPI", description: "QR or UPI application", icon: Smartphone, tone: "purple" },
    { value: "Card", label: "Card", description: "Debit or credit card", icon: CreditCard, tone: "blue" },
    { value: "Net Banking", label: "Net Banking", description: "Bank account transfer", icon: Landmark, tone: "amber" },
  ];
  ...
  return (
    <ConsultationDrawer
      ...
      description="Select the payment method used by the patient or attendant."
      accent="violet"
    ...
    >
      ...
      <InfoAlertCard
        ...
        title="Audit Trail"
        body="Confirming will mark this pathology order as paid and record the payment method in the billing audit trail."
      />
    </ConsultationDrawer>
  );
}
