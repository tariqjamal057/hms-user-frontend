// app/(dashboard)/lab/radiology/emergency-orders/[orderId]/page.tsx
"use client";
...
import { RADIOLOGY_EMERGENCY_ORDERS } from "@/lib/lab/radiology/radiology-emergency-orders-data";
...
export default function RadiologyEmergencyOrderDetailPage() {
  const params = useParams<{ orderId: string }>();
  const sourceOrder = RADIOLOGY_EMERGENCY_ORDERS.find((o) => o.id === params.orderId);
  const [order, setOrder] = useState<RadiologyIpdOrder>(() => sourceOrder ?? RADIOLOGY_EMERGENCY_ORDERS[0]);
  ...
  const patientList: PatientListItem[] = RADIOLOGY_EMERGENCY_ORDERS.map((o) => ({
    uhid: o.patient.uhid,
    name: o.patient.name,
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px]">
        <PatientDetailShell
          ...
          patientsPath="/lab/radiology/emergency-orders"
          tabs={tabs}
          defaultTab="overview"
          hideSingleTab
        />
