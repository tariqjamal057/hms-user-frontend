// app/(dashboard)/lab/radiology/icu-orders/[orderId]/page.tsx
"use client";
...
import { RADIOLOGY_ICU_ORDERS } from "@/lib/lab/radiology/radiology-icu-orders-data";
...
export default function RadiologyIcuOrderDetailPage() {
  const params = useParams<{ orderId: string }>();
  const sourceOrder = RADIOLOGY_ICU_ORDERS.find((o) => o.id === params.orderId);
  const [order, setOrder] = useState<RadiologyIpdOrder>(() => sourceOrder ?? RADIOLOGY_ICU_ORDERS[0]);
  ...
  const patientList: PatientListItem[] = RADIOLOGY_ICU_ORDERS.map((o) => ({
    uhid: o.patient.uhid,
    name: o.patient.name,
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px]">
        <PatientDetailShell
          ...
          patientsPath="/lab/radiology/icu-orders"
          tabs={tabs}
          defaultTab="overview"
          hideSingleTab
        />
