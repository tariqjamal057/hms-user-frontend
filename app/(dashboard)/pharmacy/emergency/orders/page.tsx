    ...
    },
    {
      ...
      cell: (o) => (
        <div className="text-right">
          <OpsActionButton label="View" icon={Eye} onClick={() => router.push(`/pharmacy/emergency/orders/${o.id}`)} className="border-blue-200 text-blue-700" />
        </div>
      ),
    },
  ];
...
<button
            ...
            onClick={() => router.push(`/pharmacy/emergency/orders/${o.id}`)}
          >
            Manage Order
          </button>
        </div>
