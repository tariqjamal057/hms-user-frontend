// app/(dashboard)/pharmacy/icu/orders/[orderId]/page.tsx
"use client";
...
import { getAdmittedDays } from "@/lib/pharmacy/ipd/pharmacy-ipd-order-data";
...
export default function PharmacyIcuOrderDetailPage() {
  const params = useParams<{ orderId: string }>();
  const sourceOrder = PHARMACY_ICU_ORDERS.find((o) => o.id === params.orderId);
  const [order, setOrder] = useState<PharmacyIpdOrder>(() => sourceOrder ?? PHARMACY_ICU_ORDERS[0]);
  ...
  const patientList: PatientListItem[] = PHARMACY_ICU_ORDERS.map((o) => ({
    uhid: o.uhid,
    name: o.patientName,
  ...
  return (
    <PatientDetailShell
      ...
      patientsPath="/pharmacy/icu/orders"
      tabs={tabs}
      defaultTab="today"
    />
  );
