...
import {
  ...
  PaymentBadge,
  UrgencyBadge,
} from "./_components/pharmacy-ipd-badges";
...
export default function PharmacyIpdOrdersPage() {
  ...
  const orders: PharmacyIpdOrder[] = PHARMACY_IPD_ORDERS;
    ...
    },
    {
      ...
      cell: (o) => (
        <div className="text-right">
          <OpsActionButton label="View" icon={Eye} onClick={() => router.push(`/pharmacy/ipd/orders/${o.id}`)} className="border-blue-200 text-blue-700" />
        </div>
      ),
    },
  ];
...
<button
            ...
            onClick={() => router.push(`/pharmacy/ipd/orders/${o.id}`)}
          >
            Manage Order
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen">
      <PageShellHeader
        title="Pharmacy IPD Orders"
        description="Dispense recurring ward medicines, track day-wise delivery and billing, manage returns and payments."
        meta={
          <span className="rounded-full border border-blue-200 bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700">
            Inpatient Dispensing Queue
          </span>
        }
        actions={
      ...
      <main className="py-6">
        ...
        <div className="my-6">
          <FilterBar
            ...
            searchPlaceholder="Patient Name, UHID, IPD ID, ward or bed..."
