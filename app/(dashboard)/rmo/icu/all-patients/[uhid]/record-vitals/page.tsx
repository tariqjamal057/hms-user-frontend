// app/(dashboard)/rmo/icu/all-patients/[uhid]/record-vitals/page.tsx
"use client";
  ...
  return (
    <div className="bg-slate-50/50">
      <PatientDetailShell
        ...
        onBack={() => router.push(`/rmo/icu/all-patients/${uhidState}`)}
        subtitle="ICU Patient · Record Vitals"
        headerActions={
          <PillButton
            variant="outline"
            size="sm"
            onClick={() => router.push(`/rmo/icu/all-patients/${uhidState}`)}
          >
            Back to Patient
          </PillButton>
        }
      ...
      <div className="mx-auto max-w-[1600px] px-4 py-5 sm:px-5">
        ...
        <RecordVitalsForm
          ...
          hidePatientHeader
          onSaveVitals={(data) => {
            console.log("Save RMO ICU vitals:", { uhid: uhidState, ...data });
            toast.success("Vitals saved successfully");
            router.push(`/rmo/icu/all-patients/${uhidState}`);
          }}
          onSaveDraft={(data) => {
...
export default function RmoIcuRecordVitalsPage() {
  return (
