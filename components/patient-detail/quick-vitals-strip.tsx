...
const DEFAULT_COLOR_MAP: Record<string, string> = {
  BP: "border-blue-200 bg-white text-blue-700",
  Pulse: "border-emerald-200 bg-white text-emerald-700",
  Temp: "border-amber-200 bg-white text-amber-700",
  RR: "border-violet-200 bg-white text-violet-700",
  "SpO₂": "border-cyan-200 bg-white text-cyan-700",
  Spo2: "border-cyan-200 bg-white text-cyan-700",
  Pain: "border-rose-200 bg-white text-rose-700",
};
